...
namespace Jiny\Shop\Http\Controllers\Ecommerce\Orders;
    ...
    private function showStep(Request $request, int $step)
    {
        ...
        switch ($step) {
            case 1:
                ...
                return view('jiny-shop::ecommerce.orders.steps.customer', compact('step', 'stepData', 'users'));
            ...
            case 2:
                ...
                return view('jiny-shop::ecommerce.orders.steps.products', compact('step', 'stepData'));
            ...
            case 3:
                ...
                return view('jiny-shop::ecommerce.orders.steps.shipping', compact('step', 'stepData'));
            ...
            case 4:
                ...
                return view('jiny-shop::ecommerce.orders.steps.payment', compact('step', 'stepData'));
