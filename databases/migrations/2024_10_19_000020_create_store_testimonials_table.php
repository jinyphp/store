...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('store_testimonial_likes', function (Blueprint $table) {
            $table->id();
            ...
            // Foreign keys
            $table->foreign('testimonial_id')->references('id')->on('store_testimonials')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('store_testimonial_likes');
