...
return new class extends Migration
{
    ...
    {
        Schema::create('store_inventory_transactions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('product_id')->constrained('store_products')->onDelete('cascade');
            $table->foreignId('inventory_item_id')->constrained('store_inventory_items')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('store_inventory_transactions');
    }
};
