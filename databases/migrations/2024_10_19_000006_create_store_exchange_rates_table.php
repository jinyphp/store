...
return new class extends Migration
{
    ...
    {
        Schema::create('store_exchange_rates', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            ...
            // 외래키 제약조건
            $table->foreign('from_currency')->references('code')->on('store_currencies');
            $table->foreign('to_currency')->references('code')->on('store_currencies');
    ...
    private function insertDefaultExchangeRates()
    {
        ...
        DB::table('store_exchange_rates')->insert($rates);
    }
    ...
    {
        Schema::dropIfExists('store_exchange_rates');
    }
};
