...
<body class="@yield('body-class', 'bg-white')">
    ...
    @hasSection('header')
        ...
        @yield('header')
    @else
        @includeIf($header ?? 'jiny-store::partials.headers.' . ($header ?? 'header-default'))
    @endif
    ...
    @hasSection('footer')
        ...
        @yield('footer')
    @else
        @includeIf($footer ?? 'jiny-store::partials.footers.footer')
    @endif

    <!-- Modal -->
    @include('jiny-store::partials.modals')
