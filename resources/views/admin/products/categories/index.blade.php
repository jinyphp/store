...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.store.products.categories.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.store.products.categories.index') }}">
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        @endif
                                        <div>
                                            <a href="{{ route('admin.store.products.categories.show', $category->id) }}"
